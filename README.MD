...
I use nix-darwin with home-manager to have a declarative, reproducible and version-controlled configuration.
...
# 3. Update git.nix with your GPG key ID in the signing section
